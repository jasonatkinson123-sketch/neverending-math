...
const fixtures = {
  ...
  date: fixtureDate,
  collectibles: ids,
  collectibleLabels: Object.fromEntries(collectibles),
  challenges,
  collections: {
    empty: collection(),
    small: collection({ collected: 3 }),
    studyZero: collection(),
    studyOne: collection({ collected: 1, placed: ids.slice(0, 1) }),
    studyTwo: collection({ collected: 2, placed: ids.slice(0, 2) }),
    studySeven: collection({ collected: 7, placed: ids.slice(0, 7) }),
    studyEight: collection({ collected: 8, placed: ids.slice(0, 8) }),
    studyNine: collection({ collected: 9, placed: ids.slice(0, 9) }),
    studyThirty: collection({ collected: 30, placed: ids }),
    studyOutOfOrder: collection({ collected: 8, placed: ["textbook", "pen", "bell"] }),
