...
test("one learner can complete 30 deterministic days through production state transitions", () => {
  ...
  assert.ok(
    result.findings.some((finding) => finding.code === "SECURE_NOT_DUE_REPETITION"),
    "diagnostic should preserve the current known pattern: secure, not-due skills can still be selected repeatedly",
  );
});
